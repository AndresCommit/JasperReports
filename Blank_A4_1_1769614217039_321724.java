/*
 * Generated by JasperReports - 28/1/26, 16:30
 */
 ...
 *
 */
public class Blank_A4_1_1769614217039_321724 extends JREvaluator
{
    ...
    private JRFillField field_Id_articulo = null;
    ...
    {
        field_Id_articulo = (JRFillField)fm.get("Id_articulo");
    ...
    public Object evaluate(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 8 : 
            {
                value = ((java.lang.Integer)field_Id_articulo.getValue()); //$JR_EXPR_ID=8$
                break;
            }
            case 9 : 
            {
                value = ((java.lang.String)field_Descripcion.getValue()); //$JR_EXPR_ID=9$
                break;
            }
            case 10 : 
            {
                value = ((java.math.BigDecimal)field_Precio.getValue()); //$JR_EXPR_ID=10$
                break;
            }
            case 11 : 
            {
            ...
            case 12 : 
            {
                value = ((java.lang.Integer)variable_PAGE_NUMBER.getValue()); //$JR_EXPR_ID=12$
                break;
            }
           default :
           {
    ...
    public Object evaluateOld(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 8 : 
            {
                value = ((java.lang.Integer)field_Id_articulo.getOldValue()); //$JR_EXPR_ID=8$
                break;
            }
            case 9 : 
            {
                value = ((java.lang.String)field_Descripcion.getOldValue()); //$JR_EXPR_ID=9$
                break;
            }
            case 10 : 
            {
                value = ((java.math.BigDecimal)field_Precio.getOldValue()); //$JR_EXPR_ID=10$
                break;
            }
            case 11 : 
            {
            ...
            case 12 : 
            {
                value = ((java.lang.Integer)variable_PAGE_NUMBER.getOldValue()); //$JR_EXPR_ID=12$
                break;
            }
           default :
           {
    ...
    public Object evaluateEstimated(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 12 : 
            {
                value = ((java.lang.Integer)variable_PAGE_NUMBER.getEstimatedValue()); //$JR_EXPR_ID=12$
                break;
            }
           default :
           {
